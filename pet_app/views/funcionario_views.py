...
def inserir_funcionario(request):
    if request.method == "POST":
        ...
        if form_funcionario.is_valid():
            ...
            password = make_password(form_funcionario.cleaned_data["password1"]) #pega o texto puro do conteudo da
            #password e criptografa e transforma em um hash e salva no banco de dados
