...
class Cliente(TimeStampedModel):
    ...
    endereco        =       models.ForeignKey   (   EnderecoCliente, on_delete=models.CASCADE   ) #quando o usuario for removido, o endereço também deve ser removido
